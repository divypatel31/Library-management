...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        // Fetch stats, charts, and users concurrently for maximum speed
    ...
    <div className="space-y-8">
            ...
            >
              <div className="p-6">
                 <div className="flex justify-between items-start mb-4">
                   ...
                   {/* Optional: You can make this +12% dynamic later if you track historical data */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
               ...
               {chartData.datasets && chartData.datasets.length >= 2 ? (
                 <Line 
                    ...
                    options={{
                      ...
                      scales: {
                        // UPDATE THIS Y-AXIS CONFIGURATION:
                        y: { 
                          beginAtZero: true, 
                          min: 0,
                          ticks: { 
                            color: '#64748b',
                            stepSize: 1 // Forces it to only show whole numbers (1, 2, 3) instead of 1.5
                          },
                          grid: { color: '#f1f5f9' } 
                        },
                        x: { 
         ...
         <AnimatedCard className="shadow-sm border-slate-200 bg-white">
             <h3 className="text-xl font-display font-semibold text-slate-800 mb-6">Active Roles</h3>
             <div className="h-[300px] w-full flex items-center justify-center">
